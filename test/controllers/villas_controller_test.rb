...
class VillasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create villa" do
    assert_difference('Villa.count') do
      post villas_url, params: { villa: { amount: @villa.amount, location: @villa.location, name: @villa.name } }
    end
  ...
  test "should update villa" do
    patch villa_url(@villa), params: { villa: { amount: @villa.amount, location: @villa.location, name: @villa.name } }
